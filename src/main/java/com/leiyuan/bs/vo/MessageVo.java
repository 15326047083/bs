...
public class MessageVo {
    ...
    public MessageVo(Integer id, String info, Integer userId, String time, Integer replyId, String name, String email, String phone, String password, Integer age, String sex) {
        this.id = id;
        this.info = info;
        this.userId = userId;
        this.time = time;
